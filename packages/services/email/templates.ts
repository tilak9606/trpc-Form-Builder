...
<body style="font-family: system-ui, sans-serif; max-width: 480px; margin: 40px auto; padding: 24px; color: #111;">
  ...
  <a href="${verifyUrl}" style="display: inline-block; margin: 16px 0; padding: 12px 24px; background: #000; color: #fff; text-decoration: none; border-radius: 8px; font-weight: 500;">Verify Email</a>
  <p style="color: #888; font-size: 13px;">Or copy this link: <code style="background: #f4f4f5; padding: 2px 6px; border-radius: 4px;">${verifyUrl}</code></p>
